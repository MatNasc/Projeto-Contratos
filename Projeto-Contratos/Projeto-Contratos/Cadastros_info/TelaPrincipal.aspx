            ...
            <div class="jumbotron">
                ...
                <div class="row-sm-4">
                    <div class="text-center">
                        ...
                        <asp:Button runat="server" ID="btnLocador" Text="Cadastrar" CssClass="btn btn-primary" />
                    </div>
                </div>
                <div class="row-sm-2">
                </div>
        ...
        <div class="col-sm-4">
            <div class="jumbotron">
                <div class="text-center">
                    ...
                    <asp:Button runat="server" ID="btnLocatario" Text="Cadastrar" CssClass="btn btn-primary" />
                </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="jumbotron">
                <div class="text-center">
                    ...
                    <asp:Button runat="server" ID="btnImovel" Text="Cadastrar" CssClass="btn btn-primary" />
                </div>
            </div>
        </div>
