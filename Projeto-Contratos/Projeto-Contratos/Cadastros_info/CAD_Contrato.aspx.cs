...
namespace Projeto_Contratos.Cadastros_info
{
    public partial class CAD_Contrato : System.Web.UI.Page
    {
        ...
        protected void btnCadastrarCont_Click(object sender, EventArgs e)
        {
            ...
            if (reader.Read())
            {
                id_contrato = reader.GetInt32("id");
            }
            connection.Close();
            Response.Redirect($"contrato.aspx?id_locador={id_locador}&id_locatario={id_locatario}&id_imovel={id_imovel}&id_contrato={id_contrato}");
