    ...
    <div class="container-principal">
        <div id="main">
            ...
            <div class="content-box" style="margin-right: 150px; margin-left: 150px; padding-bottom: 150px; margin-top: 50px">
                ...
                <br />
                <asp:RadioButton ID="RadioButton" Text="Locador" Checked="false" runat="server" GroupName="Pesquisa" Style="margin-left: 36%; color: aliceblue" />
                <asp:RadioButton ID="RadioButton2" Text="Locatário" Checked="false" runat="server" GroupName="Pesquisa" Style="margin-left: 10%; color: aliceblue" />
                <br />
                <br />
