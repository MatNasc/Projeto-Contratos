    ...
    <div class="container-principal">
        <div id="main">
            ...
            <div class="content-box" style="margin-right: 150px; margin-left: 150px; padding-bottom: 150px; margin-top: 50px">
                <asp:Label runat="server" Text="Cidade" Style="color: white; height: 40px; padding: 20px 20px; display: inline-block; margin-top: 50px; margin-left: 25%; font-size: 25px"></asp:Label>
                ...
                <br />
                <br />
                <asp:GridView runat="server" ID="grdImovel" OnRowCommand="grdImovel_RowCommand" AutoGenerateColumns="false" Width="100%" AllowPaging="true" PageSize="20" CssClass="table" Style="background-color: black; color: white; width: 60%; margin-left: 250px; border: thin">
                    <Columns>
                        <asp:BoundField DataField="rua" HeaderText="RUA" />
                        <asp:BoundField DataField="numero" HeaderText="NÚMERO" />
                        <asp:BoundField DataField="bairro" HeaderText="BAIRRO" />
                        <asp:BoundField DataField="cidade" HeaderText="CIDADE" />
                        <asp:BoundField DataField="num_contaagua" HeaderText="N°CONTA DE ÁGUA" />
                        <asp:BoundField DataField="num_contaluz" HeaderText="N° CONTA DE LUZ" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
